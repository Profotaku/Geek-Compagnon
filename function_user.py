	...
	if user:
		if user.profil_public or current_user.pseudo == requested_user or get_jwt_identity() == requested_user or current_user.admin:
			...
			produits_culturels = (
				...
				.outerjoin(Etre_Compose, Produits_Culturels.id_produits_culturels == Etre_Compose.id_produits_culturels)
				.outerjoin(Projets_Medias, Etre_Compose.id_projets_medias == Projets_Medias.id_projets_medias)
				.outerjoin(FichesProjetMedias, Projets_Medias.id_fiches == FichesProjetMedias.id_fiches)
				.outerjoin(NotesProjetMedias, FichesProjetMedias.id_fiches == NotesProjetMedias.id_fiches)
				.outerjoin(Contenir, Projets_Medias.id_projets_medias == Contenir.id_projets_medias)
				.outerjoin(Projets_Transmedias, Contenir.id_projets_transmedias == Projets_Transmedias.id_projets_transmedias)
				.outerjoin(FichesProjetTransmedias, Projets_Transmedias.id_fiches == FichesProjetTransmedias.id_fiches)

...
function displayResults(data) {
  ...
  allResults.forEach(function(result) {
    ...
    var resultItem = $("<div>").addClass("search-result-item hover:bg-red-600 mb-1 cursor-pointer m-2");
    ...
    resultsContainer.append(`<div class="search-result-item hover:bg-chartpink-400 min-w-full p-2">
